...
void new_3_test() {
    Big_int x("0");
    Big_int s("99999999999999999999999");
    Big_int r = s * x;
...
void new_4_test() {
    ...
    if (r==Big_int("99999999999999999999999"))
        OK("new_test_4", r, "99999999999999999999999")
    else
        FAIL("new_test_4", r, "99999999999999999999999")
}
...
void new_5_test() {
    ...
    if (r==Big_int("-100000000000000000000000"))
        OK("new_test_5", r, "-100000000000000000000000")
    else
        FAIL("new_test_5", r, "-100000000000000000000000")
}
